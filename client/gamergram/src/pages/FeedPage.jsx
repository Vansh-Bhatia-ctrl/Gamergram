    ...
    <>
      <div className="h-full w-full bg-gradient-to-b from-custompurple-100 to-customblue-100 md:flex overflow-hidden">
        ...
        <div className="w-full md:ml-[110px]">
          ...
          {/*Main feed page*/}
          <div className="flex-1 overflow-y-auto scroll-smooth sm:p-20 custom-padding-1 custom-padding-2 custom-padding-3 sm:-mt-17 md:flex md:flex-col md:items-center md:justify-center lg:flex lg:flex-row ">
            <div>
              {" "}
              {feedData.length > 0 ? (
          ...
          {/*Footer-cum-options*/}
          <div className="fixed -bottom-1 lef-0 w-screen h-[60px] bg-gradient-to-b from-customblue-200 to-custompurple-100 flex p-3 justify-between sm:justify-around md:hidden">
