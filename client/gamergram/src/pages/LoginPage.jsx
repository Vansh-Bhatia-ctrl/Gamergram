...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      throw Error("Error logging-in, please try again.");
    }
  };
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="mt-3">
              <div className="flex flex-col gap-4 p-2 items-center">
                <button className="bg-customgreen-200 hover:bg-customgreen-300 text-customgray-100 orbitron font-semibold w-[240px] h-[38px] rounded-md cursor-pointer">
                  Login
                </button>
                <p className="text-gray-400">
                  Don't have an account?{" "}
                  <a className="text-customgreen-400 cursor-pointer hover:text-customgreen-500">Sign up</a>
                </p>
              </div>
            </div>
          </form>
